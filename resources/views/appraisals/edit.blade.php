    ...
    <form action="{{ route('uncst-appraisals.update', ['uncst_appraisal' => $appraisal->appraisal_id]) }}"
        ...
        <div class="entire-form">
            ...
            <div class="p-3 mb-4 border shadow card border-primary">
                ...
                <div class="p-0 card-body">
                    <ol type="I" style="list-style-type: upper-roman; padding-left: 20px;">
                        <li class="mb-2">
                            Completing Staff Performance Assessment Forms is mandatory for all QUOTIENT members of
                            staff,
                        ...
                        <li class="mb-2">
                            Oral interviews and appearance before a QUOTIENT Management Assessment Panel may be done
                            (under
                        ...
                        <div class="col-12">
                            ...
                            <div class="mt-4 col-12">
                                ...
                                <x-forms.text-area name="training_support_needs" :isDisabled="!$appraisal->is_appraisee" :isDraft="$staffDraftValue"
                                    label="Indicate the nature of training support you may need to effectively perform your duties. Training support should be consistent with the job requirements and applicable to QUOTIENT policies and regulations."
                                ...
                                <tr class="table-primary">
                                    <td><span class="fw-bold">Commitment to Mission</span>
                                        <p class="mb-0 text-muted small">Understands and exhibits a sense of working
                                            for
                                            the QUOTIENT & at all times projects the interest of the Organization as a
                                            priority.</p>
                                    </td>
                                    <td class="text-center">4</td>
            ...
            <fieldset class="p-2 mb-4 border">
                ...
                <P>EVALUATION BY REVIEW PANEL (When deemed necessary by QUOTIENT Management and
