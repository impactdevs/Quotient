        ...
        <div class="p-3 mb-4 border shadow card border-primary">
            ...
            <div class="p-0 card-body">
                <ol type="I" style="list-style-type: upper-roman; padding-left: 20px;">
                    <li class="mb-2">
                        Completing Staff Performance Assessment Forms is mandatory for all QUOTIENT members of staff,
                    ...
                    <li class="mb-2">
                        Oral interviews and appearance before a QUOTIENT Management Assessment Panel may be done (under
