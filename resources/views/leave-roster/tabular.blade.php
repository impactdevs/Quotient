<x-app-layout>
    <div class="mt-3">
        <div class="mb-3 d-flex align-items-center">
            {{-- Add Leave Roster --}}
            <button class="mt-3 btn btn-primary btn-sm ms-1 font-weight-bold" id="addLeaveRoster" type="button"
                ...
                function leaveRosterFormatter(value) {
                    if (value) {
                        ...
                        value.forEach(function(item) {
                            ...
                            formattedValue += `
                <div class="flex-1 mb-2 roster-entry nowrap d-flex justify-content-between">
