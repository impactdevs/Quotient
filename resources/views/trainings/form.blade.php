...
<div class="border row border-5 border-success">
    ...
    <div class="mb-3 col">
        ...
        <input type="hidden" name="category[users]" id="user_ids"
            value="{{ old('category.users', isset($training) ? (isset($training->category['users']) ? $training->category['users'] : 'All') : 'All') }}" />
    </div>
    ...
    <div class="mb-3 col">
        ...
        <input type="hidden" name="category[departments]" id="department_ids"
            value="{{ old('category.departments', isset($training) ? (isset($training->category['departments']) ? $training->category['departments'] : '') : '') }}" />
    </div>
    ...
    <div class="mb-3 col">
        ...
        <input type="hidden" name="category[positions]" id="position_ids"
            value="{{ old('category.positions', isset($training) ? (isset($training->category['positions']) ? $training->category['positions'] : '') : '') }}" />
    </div>
</div>
